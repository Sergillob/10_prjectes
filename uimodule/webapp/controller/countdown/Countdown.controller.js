sap.ui.define([
  ...
  return Controller.extend("com.te.teProjects.controller.countdown.Countdown", {
    onInit: function () {
      ...
      //Per cridar la funció que volem en un interval de 1 segon
    ...
    calculateTime: function () {
      ...
      //Temps en milisegons (Math.floor per fer redondeig)
      let diff = techedDate.getTime() - currentDate.getTime();

      this.timer.days = Math.floor(diff / (1000 * 60 * 60 * 24));
      this.timer.hours = Math.floor((diff % (1000 * 60 * 60 * 24)) / (1000 * 60 * 60 * 24));
